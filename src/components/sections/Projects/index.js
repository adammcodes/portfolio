...
const Projects = () => {
  const projectContent = [
    ...
    {
      title: "The Shoppies",
      description: "Search OMDb and nominate movies for awards (Shopify challenge).",
      technologies: [
        "React",
        "Material-UI",
        "Sass",
    ...
    <div className="Projects view">
      <section>
        ...
        <div className="gh-link">
          <a className="code" href="https://github.com/MagicMark5" target="_blank" rel="noreferrer">
